        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/men" className="text-gray-300 hover:text-white">Men</Link>
              <Link href="/women" className="text-gray-300 hover:text-white">Women</Link>
              <Link href="/kids" className="text-gray-300 hover:text-white">Kids</Link>
              <Link href="/customize" className="text-gray-300 hover:text-white">Customize</Link>
              <Link href="/sale" className="text-red-500 hover:text-red-400">Sale</Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <h3 className="text-xl font-bold mb-4">SEND US FEEDBACK</h3>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">GET HELP</h4>
              <ul className="space-y-2">
                <li><Link href="/order-status" className="text-gray-400 hover:text-white">Order Status</Link></li>
                ...
                <li><Link href="/payment-options" className="text-gray-400 hover:text-white">Payment Options</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">ABOUT NIKE</h4>
              <ul className="space-y-2">
